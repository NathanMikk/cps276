...
class DatabaseConn {	
  ...
  public function dbOpen(){
    ...
    try {
      ...
      $dbHost = 'localhost';
      $dbName = 'nmikkelson';//this will be your WCC username
      $dbUsr = 'nmikkelson';//this will be your WCC username
      $dbPass = 'qKH3DXw5gawv';//this will be the password found in the video.
